...
## ใหม่ล่าสุด
- **✨ แก้/แปลคำแปลเฉพาะส่วนใหม่ — รายย่อหน้า + กำหนด prompt เอง (แท็บ อ่าน/แก้ไข)** — บางช่วง
  แปลไม่ดีแต่ไม่อยากแปลใหม่ทั้งตอน · ในโหมด 📖 อ่าน มีปุ่ม **"✎ แก้"** ต่อท้ายทุกย่อหน้า กดเพื่อ
  แก้เฉพาะย่อหน้านั้น (หรือลากเลือกข้อความเองแล้วกด "✨ แปลส่วนที่เลือกใหม่" ก็ได้) · ก่อนส่ง
  **แก้คำสั่ง (prompt) ให้ AI เองได้** เช่น "ใช้ภาษาทางการขึ้น" "ตัวละครนี้เป็นผู้หญิง" (จำค่าล่าสุด
  ต่อ workspace) · ระบบแนบต้นฉบับทั้งตอน + คลังศัพท์ + บริบทรอบข้าง + ล็อกสรรพนามให้อัตโนมัติ ·
  พรีวิวเทียบ เดิม/ใหม่ ก่อนกด "✓ รับ" (แทนที่เฉพาะส่วนนั้น) · ไม่แตะต้นฉบับ ใช้ได้ทุกตอน
  (อิงตำแหน่งตัวอักษรจาก data-coff/data-cend ของย่อหน้า ไม่พึ่งเส้นแบ่ง chunk เดิม)
