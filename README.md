...
## ใหม่ล่าสุด
- **✨ แปลคำแปลเฉพาะส่วนที่เลือกใหม่ (แท็บ อ่าน/แก้ไข)** — บางช่วงแปลไม่ดีแต่ไม่อยากแปลใหม่
  ทั้งตอน · ในโหมด 📖 อ่าน ลากเลือกข้อความช่วงที่จะแก้ แล้วกด "✨ แปลส่วนที่เลือกใหม่" — AI
  แปลเฉพาะส่วนนั้นใหม่ (อ้างอิงต้นฉบับทั้งตอน + คลังศัพท์ + บริบทรอบข้าง + ล็อกสรรพนามถ้าเปิด)
  · มีพรีวิวเทียบ เดิม/ใหม่ ก่อนกด "รับ" (แทนที่เฉพาะช่วงที่เลือก) หรือ "ปฏิเสธ"/"แปลใหม่อีกครั้ง"
  · ไม่แตะต้นฉบับ ใช้ได้กับทุกตอนไม่ว่าเคยแปลแบบไหน (อิงตำแหน่งตัวอักษรจาก data-coff ของย่อหน้า)
